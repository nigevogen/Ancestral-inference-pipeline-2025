...
CDSopt=1								# 0: nucleotide; 1: CDS

BASEML_model_pos1="model2_pos1.ctl"							# name of the control file used for BASEML (codon pos1)
BASEML_model_pos2="model2_pos2.ctl"							# name of the control file used for BASEML (codon pos2)
BASEML_model_pos3="model2_pos3.ctl"							# name of the control file used for BASEML (codon pos3)

BASEML_model_nucleotide="model2.ctl"							# name of the control file used for BASEML (nucleotide)

bin_list_folder="sample_concat_list_codons_bootstrap"							# concat list folder
