...
/*---------------------------------------------------------------------------------------*/
process_choice				= 334				/* Process shifting option */
...
MainBML45OutFld		= "5_alncds_rst_bmlo"	/* Baseml output foldername */
RstBMLPos			= "pos2_rst"	/* Baseml output rst filename */
MainFltBML45OutFld	= "5_alncds_filter_rst"	/* filtered Baseml output foldername */
FltRstBMLPos		= "pos2_fltrst"	/* filtered Baseml output rst filename */
