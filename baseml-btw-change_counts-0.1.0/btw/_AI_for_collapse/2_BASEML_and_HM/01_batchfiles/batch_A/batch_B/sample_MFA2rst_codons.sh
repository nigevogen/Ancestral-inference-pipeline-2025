...
BASEML_model_pos1="model1_pos1.ctl"							# name of the control file used for BASEML (codon pos1)
BASEML_model_pos2="model1_pos2.ctl"							# name of the control file used for BASEML (codon pos2)
BASEML_model_pos3="model1_pos3.ctl"							# name of the control file used for BASEML (codon pos3)

BASEML_model_nucleotide="model1.ctl"							# name of the control file used for BASEML (nucleotide)
