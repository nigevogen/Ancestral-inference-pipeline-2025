...
/*---------------------------------------------------------------------------------------*/
process_choice				= 333				/* Process shifting option */
...
MainMuPMLCDS			= "3_alncds_PAML"			/* mod_mss; aligned seqs in PAML format (input) */
MainMuPML3Pos			= "4_alncds_PAML_3pos"	/* mod_mss; aligned 3 position seq in PAML format (output) */
