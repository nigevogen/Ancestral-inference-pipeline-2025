...
/*---------------------------------------------------------------------------------------*/
process_choice				= 312			/* 1=codon pref test, 2=tissue MCUsp aa props, 3=tissue MCU v expr rs, 5=plot MCUsp in each tissue, see main() for others */
SubProcOpt				= 3					/* sub-Process shifting option */
...
DataTypeOpt				= 1					/* 1:cds DNA data; 2:Amino Acid data; 3:intron (DNA) data */
/*---------------------------------------------------------------------------------------*/

MainMuCDSRmgap			= ""							/* the main folder of aligned seqs without gap (input) */
DNARmGapsFld_1			= "2_alncds_cc.MFA"	/* mod_mss; the folder of aligned seqs without gap in the main folder (input) */
MainMuPMLCDS			= "3_alncds_PAML"			/* mod_mss; the folder of aligned seqs in PAML format (output) */
CDSPML_1				= "alncds.PAML"			/* mod_mss; PAML format file name (output) */
